...
| 3 | Planning (chat) | `CLAUDE.md` (if needed), `.claude/TASKS.md` — add detailed Phase 4 tasks: one per lesson-file subheading, plus a per-file review task, based on the finished skeletons from Phase 2 (detail: `.claude/TASKS.md` task 3.2) |
